...
<sage:admin code="AdminCommunities" active="Communities">
    ...
    <sage:table formId="communityForm" action="/admin/communities/index.html" itemId="id" items="${communities}" caption="Communities">
        <sage:table-button id="newCommunityAct" type="primary" label="New Community" action="/admin/communities/new.html"/>
        ...
        <sage:table-button id="deleteAct" type="danger" label="Delete" action="delete" confirm="Are you sure you wish to delete this community?"/>
    </sage:table>
</sage:admin>
