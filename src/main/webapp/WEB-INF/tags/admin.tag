        ...
        <ul class="list-group">
            <c:choose>
                <c:when test="${active == 'Home'}">
                    ...
                    <li class="list-group-item"><a href='<c:url value="/admin/communities.html"/>'><spring:message code="Communities"/></a></li>
                    <li class="list-group-item"><a href='<c:url value="/admin/users.html"/>'><spring:message code="Users"/></a></li>
                </c:when>
                <c:when test="${active == 'Communities'}">
                    <li class="list-group-item"><a href='<c:url value="/admin/index.html"/>'><spring:message code="AdminHome"/></a></li>
