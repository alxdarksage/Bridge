...
public class SignInController {
	...
	public String post(@ModelAttribute @Valid SignInForm signInForm, BindingResult result, BridgeRequest request) throws SynapseException {
		...
		if (!result.hasErrors()) {
	        try {
	            ...
	            // They accept the terms of use when creating their account, they do not need to do it here.
	            UserSessionData userSessionData = synapseClient.login(signInForm.getUserName(), signInForm.getPassword(), true);
