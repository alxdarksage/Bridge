...
import org.sagebionetworks.bridge.services.BridgeUrlHelpers;
import org.sagebionetworks.bridge.services.auth.services.AuthenticationService;
import org.sagebionetworks.bridge.services.auth.services.AuthenticationService.PW_MODE;
...
public class AuthenticationController extends BaseController {
	...
	@RequestMapping(value = BridgeUrlHelpers.AUTH_SESSION, method = RequestMethod.POST)
	public @ResponseBody
	...
	@RequestMapping(value = BridgeUrlHelpers.AUTH_SESSION, method = RequestMethod.PUT)
	...
	@ResponseStatus(HttpStatus.NO_CONTENT)
	@RequestMapping(value = BridgeUrlHelpers.AUTH_SESSION, method = RequestMethod.DELETE)
	...
	@ResponseStatus(HttpStatus.CREATED)
	@RequestMapping(value = BridgeUrlHelpers.AUTH_USER, method = RequestMethod.POST)
	...
	@RequestMapping(value = BridgeUrlHelpers.AUTH_USER, method = RequestMethod.GET)
	public @ResponseBody
	NewUser getUser(
	...
	@ResponseStatus(HttpStatus.NO_CONTENT)
	@RequestMapping(value = BridgeUrlHelpers.AUTH_USER_PASSWORD_EMAIL, method = RequestMethod.POST)
	...
	@ResponseStatus(HttpStatus.NO_CONTENT)
	@RequestMapping(value = BridgeUrlHelpers.AUTH_API_PASSWORD_EMAIL, method = RequestMethod.POST)
	...
	@ResponseStatus(HttpStatus.NO_CONTENT)
	@RequestMapping(value = BridgeUrlHelpers.AUTH_USER_PASSWORD, method = RequestMethod.POST)
	...
	@ResponseStatus(HttpStatus.NO_CONTENT)
	@RequestMapping(value = BridgeUrlHelpers.AUTH_CHANGE_EMAIL, method = RequestMethod.POST)
	...
	@ResponseStatus(HttpStatus.NO_CONTENT)
	@RequestMapping(value = BridgeUrlHelpers.AUTH_REGISTERING_USER_PASSWORD, method = RequestMethod.POST)
	...
	@ResponseStatus(HttpStatus.OK)
	@RequestMapping(value = BridgeUrlHelpers.AUTH_SECRET_KEY, method = RequestMethod.GET)
	public @ResponseBody
	...
	@ResponseStatus(HttpStatus.NO_CONTENT)
	@RequestMapping(value = BridgeUrlHelpers.AUTH_SECRET_KEY, method = RequestMethod.DELETE)
	...
	@ResponseStatus(HttpStatus.OK)
	@RequestMapping(value = BridgeUrlHelpers.AUTH_OPEN_ID_CALLBACK, method = RequestMethod.POST)
