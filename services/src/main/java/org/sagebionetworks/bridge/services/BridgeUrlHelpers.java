...
//	}
	...
	public static String makeEntityPropertyUri(Entity entity,
		...
		String uri = null;
		try {
			uri = urlPrefix + BridgeUrlHelpers.ENTITY
	...
	public static String createEntityUri(String entityId, Class<? extends Entity> entityClass, String urlPrefix){
		...
		builder.append(BridgeUrlHelpers.ENTITY);
		builder.append("/");
	...
	public static void setBaseUriForEntity(Entity entity, HttpServletRequest request){
		...
		String prefix = BridgeUrlHelpers.getUrlPrefixFromRequest(request);
		// Now build the uri.
		String uri = BridgeUrlHelpers.createEntityUri(entity.getId(), entity.getClass(), prefix);
		entity.setUri(uri);
	}
	...
	public static void setAllEntityUrls(Entity entity){
		...
		if(entity instanceof Locationable) {
			...
			able.setS3Token(entity.getUri() + BridgeUrlHelpers.S3TOKEN);
		}
	}
	...
	public static void validateAllUrls(Entity object) {
		...
		String expectedBaseSuffix = BridgeUrlHelpers.ENTITY +"/"+object.getId();
		...
		String expected = object.getUri()+BridgeUrlHelpers.ANNOTATIONS;
		...
		expected =  object.getUri()+BridgeUrlHelpers.ACL;
		...
		if(object instanceof Versionable){
			...
			expected = object.getUri()+BridgeUrlHelpers.VERSION;
			...
			expected = object.getUri()+BridgeUrlHelpers.VERSION+"/"+able.getVersionNumber();
		...
		if(object instanceof Locationable) {
			...
			expected = object.getUri() + BridgeUrlHelpers.S3TOKEN;
	...
	public static String createACLRedirectURL(HttpServletRequest request, String id){
		...
		redirectURL.append(BridgeUrlHelpers.getUrlPrefixFromRequest(request));
		redirectURL.append(BridgeUrlHelpers.ENTITY);
		redirectURL.append("/");
		redirectURL.append(id);
		redirectURL.append(BridgeUrlHelpers.ACL);
	...
	public static String getAttachmentTypeURL(ServiceConstants.AttachmentType type)
	{
		if (type == AttachmentType.ENTITY)
			return BridgeUrlHelpers.ENTITY;
		else if (type == AttachmentType.USER_PROFILE)
			return BridgeUrlHelpers.USER_PROFILE;
